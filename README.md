...
## 1. Cloning The Repository (if you have already done this, SKIP TO 2.)
...
## 2. Creating a New Branch (CONTENT LIAISONS)
...
In VSCode, click the "Synchronize" button on the bottom bar while the folder is open
...
In VSCode, click the button next to "Synchronize", search for the branch name and select it to switch branches

<img title="" src="./README-assets/1b26bba13fa415467f24c9a7fceb9f009202872c.png" alt="" data-align="center">

## 4. What Files to Keep

1. Delete EVERY other template you are not using
2. You should only have ONE HTML file

## 5. Pulling Changes

1. Changes made and pushed by others do not automatically show up, you must pull updates from the repository. This can be for many reasons such as a tester that is currently testing a branch while the developer is making changes

2. Pull Changes using the following command
...
        Use the "Synchronize" button in VSCode
...
4. Leave a comment starting witht he commit hash so that it links to the specific commit and change the label to **review needed**
   
   <img title="" src="./README-assets/ed3f5a637f056f1d1c9b702f508f10a32dc56b38.png" alt="" data-align="center">

## 8. File Structure

1. Ensure file structure is present so that there will be no merge conflicts
   ...
   > ![](./README-assets/a6736d7ea9e7eb3734f313725201817a2516dfe1.png)

## 9. Pull Requests (TESTERS)
...
## 10. Pull Request Review & Approval (CONTENT LIAISONS & ADMINS)
